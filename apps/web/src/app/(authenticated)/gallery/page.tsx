...
export default async function GalleryPage() {
  ...
  return (
    <>
      <div className="mx-auto -mt-2 mb-4 flex max-w-[1800px] justify-end gap-2">
        <Link
          href="/gallery/albums"
          className="bg-muted hover:bg-muted/70 inline-flex h-9 items-center gap-1.5 rounded-full px-4 text-sm font-semibold"
        >
          <FolderOpen className="size-4" /> Álbumes
        </Link>
        <Link
          href="/gallery/upload"
          className="bg-primary text-primary-foreground inline-flex h-9 items-center gap-1.5 rounded-full px-4 text-sm font-semibold"
        >
