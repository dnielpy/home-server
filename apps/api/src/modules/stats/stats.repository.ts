...
import { db, stats } from "@home-server/database";
...
export class StatsRepository {
  public async insert(metrics: SystemMetrics) {
    await db.insert(stats).values({
      ...
      networkReceivedBytes: metrics.network.receivedBytes,
      networkTransmittedBytes: metrics.network.transmittedBytes,
